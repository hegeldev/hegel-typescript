 ...
 * `hegel-rust/hegel-c/include/hegel.h`, version 0.33.3) via {@link koffi}.
 *
 ...
 * `alphabet` generator of `hegel_string_generator_regex` (the client never
 * constrains regex output to a custom alphabet).
 */
